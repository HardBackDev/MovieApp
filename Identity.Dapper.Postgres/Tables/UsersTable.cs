    ...
    internal class UsersTable
    {
        ...
        public async Task<IdentityResult> CreateAsync(ApplicationUser user)
        {
            ...
            const string command = "INSERT INTO identity_users " +
                                   ...
                                   "@PhoneNumber, @PhoneNumberConfirmed, @TwoFactorEnabled, @LockoutEnd, @LockoutEnabled, @AccessFailedCount, @RefreshToken, @RefreshTokenExpiryTime);";
        ...
        {
            const string command = "SELECT * FROM identity_users WHERE normalized_username = @NormalizedUserName";
        ...
        public async Task<IdentityResult> UpdateAsync(ApplicationUser user)
        {
            ...
            const string updateUserCommand =
                ...
                "access_failed_count = @AccessFailedCount, refresh_token = @RefreshToken, refresh_token_expiry_time = @RefreshTokenExpiryTime " +
                "WHERE id = @Id;";
